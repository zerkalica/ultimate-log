 ...
 * @param {String|undefined} logObject.type      Severity of message: debug, info, warn, error
 * @param {String|undefined} logObject.id        Session id
...
proto.sessionStart = function Logger_sessionStart(options) {
	...
	this._sessionIds[id] = setTimeout(this._sessionStopFallback.bind(this, id), this.sessionLifeTime);
