 ...
 * @return {Object} this
 */
proto.start = function SimpleFacade_start(sessionOptions) {
	this._session = this._logger.sessionStart(sessionOptions);
 ...
 */
proto.setSessionData = function SimpleFacade_setSessionData(data) {
